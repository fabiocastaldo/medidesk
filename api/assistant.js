...
- In «Sicurezza», sezione «Password»: «Cambia password» con nuova password e conferma (almeno 8 caratteri, maiuscola, minuscola, numero e carattere speciale); non passa dall'email e non chiude la sessione. Sezione «Sessioni»: «Esci da tutti i dispositivi» chiude l'accesso ovunque, anche sul dispositivo in uso, dopo conferma. Sezione «Formazione sulla sicurezza»: percorso a 11 moduli in due parti («Delphi~Med e i tuoi dati» e «Cybersicurezza per chi cura»), tre minuti l'uno; oggi i moduli sono «In preparazione» e non si aprono.
...
- Cambiare la password: «Sicurezza» → «Password» → «Cambia password» (serve la sessione aperta, niente email). Password dimenticata: dal login, «Password dimenticata?» manda il link di reset via email.
