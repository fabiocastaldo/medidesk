...
- Ogni centro attivo ha, sotto i turni, la sezione a scomparsa «Associa prestazioni»: tutte le prestazioni del medico partono selezionate e si spengono toccandole quelle che non fa in quel centro; «Deseleziona tutto» le spegne tutte per poi riaccendere solo quelle offerte. Le prestazioni spente in un centro NON compaiono tra i tipi di visita prenotabili per quel centro: ne' online, ne' nel wizard del gestionale, ne' nella plancia della cooperativa che gestisce il centro; anche una prenotazione inviata a mano con una prestazione spenta viene rifiutata dal server. Le nuove prestazioni nascono attive in tutti i centri.
...
- Limitare le prestazioni di un centro: pagina Centri, sezione «Associa prestazioni» del centro; le prestazioni non associate spariscono dai tipi di visita prenotabili in quel centro, anche per la segreteria della cooperativa.
