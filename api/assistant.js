...
- Pannello «Crea gruppo di destinatari»: si dà un nome al gruppo (campo in testa) e si impostano i criteri facoltativi — età da/a, «Nessuna visita da» N giorni, «Motivo della visita» a scelta multipla con le chip delle prestazioni a catalogo (tutte selezionate = nessun filtro), «Area tematica» a chip (solo se il medico ha aree), prima visita o controllo, intervallo «Prenotati dal»/al. I criteri legati alle visite guardano i soli appuntamenti attivi del paziente, agganciati per email. «Anteprima destinatari» mostra chi ricevera'; «Salva gruppo» memorizza i criteri col nome scelto, riusabili.
