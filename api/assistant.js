...
- Pannello «Nuovo invio»: criteri facoltativi (eta' minima e massima, «Nessuna visita da (giorni)», tipo di visita, prima visita o controllo) e testo del messaggio. «Ottimizza con AI» riformula il testo della bozza in tono chiaro e cordiale senza inventare contenuti (e senza dati riferiti al singolo paziente); gli inviti a chiamare o contattare lo studio vengono riscritti come invito a prenotare online, perche' la mail porta gia' il bottone di prenotazione. «Anteprima destinatari» mostra chi lo ricevera'; «Salva come cluster» memorizza i criteri con un nome riusabile; «Invia a tutti» chiede una seconda conferma col numero esatto di destinatari e poi invia: ogni paziente riceve una semplice email col testo della comunicazione nel corpo, da consultare — nessun canale di risposta, a differenza dei messaggi singoli — con il bottone per prenotare online (porta alla pagina di prenotazione pubblica del medico) e in calce il link per revocare il consenso. Il testo viaggia in chiaro via email: mai contenuti clinici o riferiti al singolo paziente.
