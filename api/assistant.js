...
- «Piani»: abbonamento e fatturazione. «Profilo»: dati del medico, specializzazioni, firma. «Impostazioni»: notifiche, preferenze e tema, esportazione dei dati, conservazione, verifica in due passaggi; in fondo la «Zona pericolosa» con «Elimina account». «Archivio»: manutenzione e pulizia dati.
- In «Impostazioni», in fondo, sezione «Verifica in due passaggi»: «Attiva verifica in due passaggi» mostra un codice QR da inquadrare con un'app di autenticazione (Google Authenticator, Microsoft Authenticator o il gestore di password) e chiede il primo codice a 6 cifre per confermare («Conferma e attiva»); i dispositivi registrati si tolgono con «Rimuovi»; si puo' aggiungere un secondo dispositivo. Facoltativa: chi non la attiva entra come prima.
