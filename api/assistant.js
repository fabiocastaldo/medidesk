...
COME SI FA
- Verifica in due passaggi: si attiva da «Sicurezza» → «Verifica in due passaggi»; da quel momento a ogni nuovo accesso, dopo email e password, compare la schermata «Codice di verifica» con il codice a 6 cifre dell'app (cambia ogni 30 secondi, funziona anche senza rete). Non viene chiesto a ogni operazione, solo a ogni nuovo accesso. Consiglio: app di autenticazione con backup attivo, oppure un secondo dispositivo registrato con una chiave a se'. Se il medico perde il telefono e non ha un secondo dispositivo, deve scrivere al supporto: dal gestionale non si puo' aggirare.
