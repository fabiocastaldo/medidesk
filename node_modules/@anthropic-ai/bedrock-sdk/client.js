...
class AnthropicBedrock extends client_1.BaseAnthropic {
     ...
     */
    constructor({ awsRegion = (0, env_1.readEnv)('AWS_REGION') ?? 'us-east-1', baseURL = (0, env_1.readEnv)('ANTHROPIC_BEDROCK_BASE_URL') ?? `https://bedrock-runtime.${awsRegion}.amazonaws.com`, apiKey = (0, env_1.readEnv)('AWS_BEARER_TOKEN_BEDROCK'), awsSecretKey = null, awsAccessKey = null, awsSessionToken = null, providerChainResolver = null, ...opts } = {}) {
    ...
    async prepareRequest(request, { url, options }) {
        ...
        request.headers = (0, headers_1.buildHeaders)([request.headers, headers]).values;
    }
