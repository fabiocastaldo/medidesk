...
export function detailCard(rowsHtml) {
  return `<table width="100%" cellpadding="0" cellspacing="0" style="width:100%;background:${C.detailBg};border:1px solid ${C.detailBorder};border-radius:8px;margin:0 0 28px;">
  <tr><td style="padding:20px 24px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="width:100%;">${rowsHtml}</table>
  </td></tr>
</table>`;
}
