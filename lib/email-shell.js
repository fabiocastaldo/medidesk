...
export function detailCard(rowsHtml) {
  // Struttura identica alla vecchia buildHtml (commit 17b9d82) che rendeva full-width
  // su Gmail mobile: SOLO l'attributo HTML width="100%", nessun width:100% ne'
  // table-layout:fixed inline (era quello ad far collassare la tabella annidata su Gmail).
  return `<table width="100%" cellpadding="0" cellspacing="0" style="background:${C.detailBg};border:1px solid ${C.detailBorder};border-radius:8px;margin-bottom:28px;">
