...
//   { a:'c', ap:<appuntamento_id>, v, exp }   richiesta di consenso (mail automatica)
...
export function consensoLink(host, secret, { apptId }) {
  const payload = { a: 'c', ap: apptId, v: CONS_COMM_VERSIONE, exp: Date.now() + 30 * 86400000 };
